...
v3.3 進一步整合 PaperOrchestra（Song et al., 2026）的技術：**Semantic Scholar API 驗證**提供程式化引用查核、**反洩漏協議**防止 LLM 用訓練記憶偷偷填補空缺、**VLM 圖表驗證**用視覺模型閉環檢查生成的圖表品質、**分數軌跡追蹤**偵測修訂是否意外損害特定品質維度。
